...
class play_video_intro_screen extends StatefulWidget {
  final title;
  final url;
  final week;
  final day;

  const play_video_intro_screen(
      {Key? key, this.title, this.url, this.week, this.day})
      : super(key: key);

  @override
  _play_video_intro_screen createState() => _play_video_intro_screen();
}

class _play_video_intro_screen extends State<play_video_intro_screen> {
  ...
  setThubm() async {
    ...
    final fileName = await VideoThumbnail.thumbnailFile(
      video:
          'https://firebasestorage.googleapis.com/v0/b/research-cvs.appspot.com/o/Untitled%20(2).mp4?alt=media&token=24d82f0c-008a-4c34-9daa-b09dfd368814',
      // 'https://firebasestorage.googleapis.com/v0/b/research-cvs.appspot.com/o/videoplayback.mp4?alt=media&token=70875902-16a9-44f9-b812-e76c19267d5c',
  ...
  setData() async {
    ...
    if (pref.getString('intro_url') == null) {
      ...
      pref.setString('intro_url', dirPath!);
      _durationState =
      ...
      setState(() {
        dirPath = pref.getString('intro_url');
      });
      _durationState =
          Rx.combineLatest2<Duration, PlaybackEvent, DurationState>(
              _player.positionStream,
