...
class play_video_screen extends StatefulWidget {
  final title;
  final url;
  final week;
  final day;

  const play_video_screen({Key? key, this.title, this.url, this.week, this.day})
      : super(key: key);

  @override
  _play_video_screen createState() => _play_video_screen();
}

class _play_video_screen extends State<play_video_screen> {
  ...
  setThubm() async {
    ...
    final fileName = await VideoThumbnail.thumbnailFile(
      video:
          // 'https://firebasestorage.googleapis.com/v0/b/research-cvs.appspot.com/o/Untitled.mp4?alt=media&token=f24efa66-0ba0-434f-b9ee-5f49eb3ccd87',
          'https://firebasestorage.googleapis.com/v0/b/research-cvs.appspot.com/o/day_video.mp4?alt=media&token=7958a704-e95e-4403-9ec7-dac9a0451ec3',
  ...
  setData() async {
    ...
    if (pref.getString('relax_url') == null) {
      ...
      pref.setString('relax_url', dirPath!);
      _durationState =
      ...
      setState(() {
        dirPath = pref.getString('relax_url');
      });
      _durationState =
          Rx.combineLatest2<Duration, PlaybackEvent, DurationState>(
              _player.positionStream,
